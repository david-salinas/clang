  ...
  public:
      ...
      if (auto *UA = dyn_cast<OffloadUnbundlingJobAction>(HostAction)) {
        ...
        for (unsigned I = 0, E = GpuArchList.size(); I != E; ++I) {
          ...
          UA->registerDependentActionInfo(
              ToolChains[0], CudaArchToString(GpuArchList[I]), AssociatedOffloadKind);
        }
        return ABRT_Success;
      }
    ...
    void appendTopLevelActions(ActionList &AL) override {
      ...
      auto AddTopLevel = [&](Action *A, CudaArch BoundArch) {
        ...
        Dep.add(*A, *ToolChains.front(), CudaArchToString(BoundArch), AssociatedOffloadKind);
    ...
    bool initialize() override {
      ...
      if (AssociatedOffloadKind == Action::OFK_HIP && !C.hasOffloadToolChain<Action::OFK_HIP>())
        return false;
